...
public class BackendHandler : MonoBehaviour
{
    ...
    const string urlBackendHighScoresFile = "http://172.30.139.22/~narvanen/UnityPHP/api/v1/highscores.json";
    const string urlBackendHighScores = "http://172.30.139.22/~narvanen/UnityPHP/api/v1/highscores.php";
